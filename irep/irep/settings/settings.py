"""
Django settings for irep project.
...
ADMINS = (
    ('your name', 'your-email@imsweb.com'),
)
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'irep.context_processors.irep_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'irep.wsgi.application'
...
CACHES = {
    'default': {
        'BACKEND': 'irep.caches.NoCullFileBasedCache',
