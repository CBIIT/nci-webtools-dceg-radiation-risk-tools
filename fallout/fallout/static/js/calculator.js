...
$.Class.extend("FormSet", {
  ...
  _createAddLink : function() {
    ...
    this.formset.append('<a id="' + this.formset_add_id + '" class="add-form-link button button-secondary mt-1 mb-1" role="button" href="#"><img src="' + this.add_url + '" height="16" width="16" title="Add Exposure" alt="Add Exposure" />' + label +'</a>');
    var this_class = this;
  ...
  _createNewForm : function(event) {
    ...
    $(new_form).insertBefore($(this.empty_form)).removeClass('empty-form').addClass('form');
  	...
  	//$("#id_location_-" + this.num_forms + "-year").select2({width: "100px"});
